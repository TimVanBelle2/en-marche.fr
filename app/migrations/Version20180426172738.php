...
class Version20180426172738 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE committee_referent_tag (committee_id INT UNSIGNED NOT NULL, referent_tag_id INT UNSIGNED NOT NULL, INDEX IDX_285EB1C5ED1A100B (committee_id), INDEX IDX_285EB1C59C262DB3 (referent_tag_id), PRIMARY KEY(committee_id, referent_tag_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event_referent_tag (event_id INT UNSIGNED NOT NULL, referent_tag_id INT UNSIGNED NOT NULL, INDEX IDX_D3C8F5BE71F7E88B (event_id), INDEX IDX_D3C8F5BE9C262DB3 (referent_tag_id), PRIMARY KEY(event_id, referent_tag_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
