Feature: The goal is to donate one time or multiple time with a subscription
  ...
  Scenario: An anonymous user can donate successfully
    ...
    Then I wait 2 second until I see "Numéro de carte"
    ...
    And I press "VALIDER"
    Then I wait 2 second until I see "PAIEMENT ACCEPTé"
  ...
  @javascript
  Scenario: The logged user can subscribe to donate each month successfully but can't have a second subscription
    Given the following fixtures are loaded:
      | LoadAdherentData |
